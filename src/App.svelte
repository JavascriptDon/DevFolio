...
<main class="bg-body text-white font-Montserrat pb-12 scroll-behavior: smooth; overflow-scroll">
    ...
    <div class="container mx-auto mt-8 md:mt-0 md:space-x-10 md:grid grid-cols-3 justify-center md:py-40" id="home" >
      ...
      <div class="mt-8 md:mt-0 lg:justify-end col-span-2">
          <h1 class="text-4xl text-gray-800 text-center md:text-left font-bold mb-6">
              ...
              <span class="block text-indigo-600 xl:inline">Creative Web <Typewriter loop><span>Technologist.</span><span>Designer.</span><span>Coder.</span></Typewriter></span>
            </h1>
        <p class="text-xl text-gray-500 text-center font-medium md:text-left">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
        <button class="block mt-8 mx-auto md:mx-0 text-2xl py-2 px-6 text-red-50 font-semibold rounded bg-indigo-500 hover:bg-indigo-800">Download Resume</button>
      </div>
    </div>
      </Transition>
  </header>
  ...
  <div class="container mt-40 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full" id="portfolio">
      ...
      >
        <section class="w-full text-center">
          ...
          <p class="section-paragraph md:text-left text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullamcorper nulla nunc quis molestie volutpat elementum at. Ultrices ipsum, enim cursus lorem ac. Orci maecenas praesent arcu eget orci est orci nullam. Leo purus est pellentesque massa at tortor, est. Aliquet pulvinar a mattis sagittis. Suspendisse porta id elementum, massa.</p>
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <img src="https://images.unsplash.com/photo-1558655146-d09347e92766?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=764&q=80" class="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover hover:scale-110 transition duration-300 ease-in-out" alt="">
            <img src="https://images.unsplash.com/photo-1547119957-637f8679db1e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" class="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover hover:scale-110 transition duration-300 ease-in-out" alt="">
            <img src="https://images.unsplash.com/photo-1559028012-481c04fa702d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1336&q=80" class="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover hover:scale-110 transition duration-300 ease-in-out" alt="">
          </div>
        </section>
           </Transition>
      </div>
  ...
  <!-- Clients -->
  <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full" id="clients">
        <Transition
          transitions="transition transform"
          inTransition="ease-out duration-1000"
          inState="opacity-0 -translate-y-16"
      ...
      >
        <section class="w-full">
          <h2 id="clients" class="secondary-title md:text-left text-4xl font-bold mb-6 text-white">Clients</h2>
          <p class="section-paragraph md:text-left text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullamcorper nulla nunc quis molestie volutpat elementum at. Ultrices ipsum, enim cursus lorem ac. Orci maecenas praesent arcu eget orci est orci nullam. Leo purus est pellentesque massa at tortor, est. Aliquet pulvinar a mattis sagittis. Suspendisse porta id elementum, massa.</p>
            ...
            <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap hover:scale-110 transition duration-300 ease-in-out">
              ...
              <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
                ...
                <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullamcorper nulla nunc quis molestie volutpat elementum at. Ultrices ipsum, enim cursus lorem ac. Orci maecenas praesent arcu eget orci est orci nullam. Leo purus est pellentesque massa at tortor, est. Aliquet pulvinar a mattis sagittis. Suspendisse porta id elementum, massa.</p>
                  <a class="mt-10 text-gray-50 inline-flex items-center font-bold" href="#Demo">Learn More
  ...
  <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full" id="hire">
      ...
      >
        <section class="w-full">
          <h2 id="hire" class="secondary-title md:text-left mb-6 font-bold text-4xl">Hire me</h2>
          <p class="section-paragraph md:text-left text-gray-500 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          ...
          <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
            <div class="space-y-12">
              <div>
                ...
                <input type="name" class="text-black w-full border border-input-border bg-input px-4 py-4">
              </div>
              <div>
                <label class="text-white block mb-6 text-xl font-bold" for="">Email</label>
                <input type="email" class="text-black w-full border border-input-border bg-input px-4 py-4">
              </div>
              <div>
                <label class="text-white block mb-6 text-xl font-bold" for="">Message</label>
                <textarea type="message" class="text-black w-full border border-input-border bg-input px-4 py-4 h-56 resize-none"></textarea>
              </div>
            ...
            <div class="mt-12">
              ...
              <a href="mailto:email@mydomain.com" class="md:text-left text-error underline mt-3 block uppercase">email@mydomain.com</a>
              ...
              <div class="flex mt-20 space-x-6">
                ...
                <!-- Facebook -->
               <a href="#facebook">
                      <svg class="w-8 h-8 lg:w-12 lg:h-12" viewBox="0 0 512 512" width="42" height="42" fill="none">
